			...
			<view class="data_box">
				<view class="data_list" v-for="(item,index) in activeList" :key="index" @tap="toDetail(item.id)">
					...
					<view class="data_list_info">
						...
						<view class="data_list_info_text">座位号:{{item.seatName}}</view>
						<view class="data_list_info_text">剧场地址:{{item.content.attr_address}}</view>
						<view class="data_list_info_text">剧场电话:{{item.content.attr_phone}}</view>
					</view>
				</view>
			</view>
		</ys-scroll>
