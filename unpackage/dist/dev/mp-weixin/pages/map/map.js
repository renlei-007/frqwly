...
/* harmony import */ var _map_vue_vue_type_template_id_0b31f540___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./map.vue?vue&type=template&id=0b31f540& */ 69);
...
try {
  components = {
    slFilter: function() {
      return __webpack_require__.e(/*! import() | components/sl-filter/sl-filter */ "components/sl-filter/sl-filter").then(__webpack_require__.bind(null, /*! @/components/sl-filter/sl-filter.vue */ 566))
    },
    ysScroll: function() {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var slFilter = function slFilter() {__webpack_require__.e(/*! require.ensure | components/sl-filter/sl-filter */ "components/sl-filter/sl-filter").then((function () {return resolve(__webpack_require__(/*! @/components/sl-filter/sl-filter.vue */ 566));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default =
...

{
  ...
  methods: {
        ...
        res.data.body.map(function (item) {
          if (item.field == 'type') {
            ...
            array.map(function (k, v) {
              _this3.cateList.push({ title: k });
              _this3.menuList[0].detailList.push({ title: k, value: k });
            });
          }
        });
        // this.cutList = array
    ...
    getCatePointList: function getCatePointList() {var _this4 = this;
      var params = {
        channelIds: 147,
        count: 25,
        points: this.points,
      ...
      position.then(function (res) {
        ...
        params['lat'] = _this4.lat;
        params['lng'] = _this4.lng;
        _this4.indexRequest({ url: '/query/position', data: params }).then(function (res) {
          console.log(res);
          ...
          _this4.pointList = res.data.body.data;
        });
      });
    },
