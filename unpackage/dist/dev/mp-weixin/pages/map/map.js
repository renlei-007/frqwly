...
/* harmony import */ var _map_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./map.vue?vue&type=style&index=0&lang=scss& */ 66);
...
try {
  components = {
    slFilter: function() {
      return __webpack_require__.e(/*! import() | components/sl-filter/sl-filter */ "components/sl-filter/sl-filter").then(__webpack_require__.bind(null, /*! @/components/sl-filter/sl-filter.vue */ 651))
    },
    ysScroll: function() {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var slFilter = function slFilter() {__webpack_require__.e(/*! require.ensure | components/sl-filter/sl-filter */ "components/sl-filter/sl-filter").then((function () {return resolve(__webpack_require__(/*! @/components/sl-filter/sl-filter.vue */ 651));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default =
    ...
    getCatePointList: function getCatePointList() {var _this4 = this;
      ...
      position.then(function (res) {
        ...
        _this4.indexRequest({ url: '/query/position', data: params }).then(function (res) {
          console.log(res);
          if (res.data.body.data.length == 0 && _this4.pointList.length == 0) {
            _this4.$refs.scroll.setLoadStatus('no_data');
          } else {
            _this4.pointList = _this4.pointList.concat(res.data.body.data);
