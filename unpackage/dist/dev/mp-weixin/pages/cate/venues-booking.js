...
var _venuesBooking = _interopRequireDefault(__webpack_require__(/*! ./pages/cate/venues-booking.vue */ 442));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _venues_booking_vue_vue_type_template_id_37e24347___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./venues-booking.vue?vue&type=template&id=37e24347& */ 443);
/* harmony import */ var _venues_booking_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./venues-booking.vue?vue&type=script&lang=js& */ 445);
...
/* harmony import */ var _venues_booking_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./venues-booking.vue?vue&type=style&index=0&lang=scss& */ 447);
...
var component = Object(_E_hbx_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _venues_booking_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _venues_booking_vue_vue_type_template_id_37e24347___WEBPACK_IMPORTED_MODULE_0__["render"],
  _venues_booking_vue_vue_type_template_id_37e24347___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null,
  false,
  _venues_booking_vue_vue_type_template_id_37e24347___WEBPACK_IMPORTED_MODULE_0__["components"],
  renderjs
)

component.options.__file = "pages/cate/venues-booking.vue"
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "recyclableRender", function() { return _E_hbx_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_E_hbx_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_16_0_E_hbx_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_template_js_E_hbx_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_uni_app_loader_page_meta_js_E_hbx_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_index_js_vue_loader_options_E_hbx_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_style_js_venues_booking_vue_vue_type_template_id_37e24347___WEBPACK_IMPORTED_MODULE_0__["recyclableRender"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "components", function() { return _E_hbx_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_E_hbx_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_16_0_E_hbx_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_template_js_E_hbx_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_uni_app_loader_page_meta_js_E_hbx_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_index_js_vue_loader_options_E_hbx_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_style_js_venues_booking_vue_vue_type_template_id_37e24347___WEBPACK_IMPORTED_MODULE_0__["components"]; });
...
var _default =
{
  ...
  computed: {
    maxScheduled: function maxScheduled() {
      var array = [];
  ...
  methods: {
    ...
    selected: function selected(val) {//调起选择器组件
      ...
      if (val == 0) {
        ...
        if (this.date) {
          var array = [];
          this.bookingDates[this.dateIndex].slots.map(function (item) {
        ...
        this.pickTitle = '选择社团';
        var arr = [];
        this.teamList.map(function (item) {
        ...
        this.memberList.map(function (item) {
          if (item.realname) {
            _arr.push(item.realname);
          } else {
            _arr.push(item.username);
          }
        });
        this.$refs.ysPicker.showModal('radio', _arr);
      }
    },
