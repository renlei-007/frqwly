...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"furong","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var img_upload_name = 'img'; //图片上传名字
var
common = /*#__PURE__*/function () {
  function common() {_classCallCheck(this, common);
    ...
    _vue.default.prototype.domainName = 'https://sgydev.douhuomall.com'; //域名
    ...
    {var _this = this;
      _vue.default.prototype.request = function (obj) {var _obj$url =
        ...
        obj.url,url = _obj$url === void 0 ? "" : _obj$url,_obj$method = obj.method,method = _obj$method === void 0 ? 'POST' : _obj$method,_obj$data = obj.data,data = _obj$data === void 0 ? {} : _obj$data,_obj$is_token = obj.is_token,is_token = _obj$is_token === void 0 ? false : _obj$is_token,success = obj.success,fail = obj.fail,_complete = obj.complete;
        var reg = new RegExp("^http");
        var is_domainName = url.match(reg);
        var request_url = url;
        if (!is_domainName) {
          request_url = _vue.default.prototype.domainName + request_url;
        }
        if (is_token) {
    ...
    {
      _vue.default.prototype.upload = function (path, data) {
        var request_url = _vue.default.prototype.domainName + img_upload_path;
        data.access_token = uni.getStorageSync('access_token');
        //获取微信小程序信息
       ...
       */ }, { key: "_setCurrentPages", value: function _setCurrentPages()
    {
      _vue.default.prototype.beforePage = function (obj) {var _obj$before =
        ...
        obj.before,before = _obj$before === void 0 ? 1 : _obj$before,_obj$data2 = obj.data,data = _obj$data2 === void 0 ? '' : _obj$data2,_obj$fn = obj.fn,fn = _obj$fn === void 0 ? 'init' : _obj$fn;
        var pages = getCurrentPages();
...
/* 12 */
/*!******************************************!*\
  !*** D:/我的/qianduan-fr/common/index.css ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
